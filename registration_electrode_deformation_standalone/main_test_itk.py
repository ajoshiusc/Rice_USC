sub_bse_t2 = "/deneb_disk/RodentTools/for_Seymour/test2_59/R59.reoriented.bse.nii.gz" #subbase+".bfc.nii.gz"
...
def run_test(output_dir="output_R59_test"):
    ...
    run_registration(sub_bse_t2, atlas_bse_t2, atlas_labels, output_dir, skip_affine=True)
